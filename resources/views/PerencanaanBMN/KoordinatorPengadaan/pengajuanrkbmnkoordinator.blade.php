...
@section('content')
    ...
    @include('PerencanaanBMN.KoordinatorPengadaan.ReviewModal')
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            const table = $('.tabelbagian').DataTable({
                ...
                ajax:"{{route('persetujuanusulanrkkoordinator')}}",
                columns: [
                    {
                        data: 'action',
                        name: 'action',
    ...
    <script>
        var kirimUrl ="{{ url('kembalikepelaksanapengadaan') }}"
        var baseUrl = "{{ url('pengajuanrkbmn') }}";  // Untuk Review dan Delete
    </script>



    <script src="resources\views\PerencanaanBMN\KoordinatorPengadaan\script\table.js"></script>
@endsection
