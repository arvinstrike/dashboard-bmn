{{--resources/views/PerencanaanBMN/Bagian/pelaksana_nonsbsk/DashboardPageReguler.blade.php--}}
@extends('layouts.app')
...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container">
            <h1>[Pelaksana Pengadaan] Dashboard Pengajuan RKBMN Non SBSK</h1>
        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Daftar Pengajuan untuk Review</h3>
                    ...
                    <table id="pengajuanTable" class="table table-bordered table-striped">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th><input type="text" class="form-control form-control-sm filter-input" data-column="3" placeholder="Filter pengaju..."></th>
                                ...
                                <tr>
                                    <td>
                                        {{ $p->kode_pengajuan ?? ($p->tipe_pengajuan == 'revisi'
                                            ...
                                            : "PRC-{$p->id_bagian_pengusul}-".($tahunanggaran)."-".str_pad($p->id, 5, '0', STR_PAD_LEFT))
                                        }}
                                    </td>
                                    <td>
                                        @php
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('pelaksana.review', $p->id) }}" class="btn btn-info btn-sm mr-1" title="Review Pengajuan">
                                                Review
                                            </a>
                                        </div>
                                    </td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center py-4">
                                        ...
                                        <small class="text-muted">Pengajuan akan muncul ketika ada pengajuan baru dari operator atau pengajuan yang ditolak koordinator</small>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
