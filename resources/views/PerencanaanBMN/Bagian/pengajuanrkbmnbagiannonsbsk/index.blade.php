{{--resources/views/PerencanaanBMN/Bagian/pengajuanrkbmnbagiannonsbsk/DashboardPageReguler.blade.php--}}
@extends('layouts.app')
...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container">
            <h1>Dashboard Pengajuan</h1>
            <p><strong>Tahun Anggaran:</strong> {{ $tahunanggaran }}</p>
            <p><strong>Bagian:</strong> {{ $deskripsi }}</p>
                            ...
                            <tr>
                                ...
                                <th>
                                    <select class="form-control form-control-sm filter-input" data-column="2">
                                        ...
                                        <option value="Diajukan ke Unit Pelaksana">Diajukan ke Unit Pelaksana</option>
                                        <option value="Diajukan ke Koordinator">Diajukan ke Koordinator</option>
                                        <option value="Disetujui">Disetujui</option>
                                        <option value="Ditolak Pelaksana">Ditolak Pelaksana</option>
                                        <option value="Ditolak oleh Koordinator">Ditolak oleh Koordinator</option>
                                    </select>
                                </th>
                                <th><input type="text" class="form-control form-control-sm filter-input" data-column="3" placeholder="Filter pembuat..."></th>
                        ...
                        <tbody>
                            @forelse($pengajuan as $p)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('pengajuan.review', $p->id) }}" class="btn btn-info btn-sm mr-1" title="Review Pengajuan">
                                                Review
                                            </a>
                                            @if(in_array($p->status_pengajuan, ['Draft', 'Ditolak Pelaksana', 'Ditolak oleh Koordinator']))
                                                <a href="{{ route('pengajuan.edit', $p->id) }}" class="btn btn-warning btn-sm" title="Edit Pengajuan"
                                                   onclick="window.location.href='{{ route('pengajuan.edit', $p->id) }}'; return false;">
                                                   Edit
                                                </a>
                                            @endif
                                        </div>
