...
<head>
    <meta charset="UTF-8">
    <title>Nota Dinas Eselon II - Usulan PSP</title>
    <style>
        @page {
            size: A4 portrait;
            margin: 2cm;
        ...
        /* Header Layout - Menggunakan struktur dari NodinEselonIII.blade.php */
        .header {
            position: relative;
            text-align: center;
...
<body>
    <!-- Header/Kop Surat - Struktur sama dengan NodinEselonIII -->
    <div class="header">
        <div class="logo">
    ...
    <div class="sub-header">
        {{ strtoupper($biro_nama ?? 'BIRO KEUANGAN') }}
    </div>
    ...
    <div class="document-info">
        <table>
            <tr>
                ...
                <td class="colon">:</td>
                <td>{{ $kepada ?? 'Plt. Deputi Bidang Administrasi' }}</td>
            </tr>
            <tr>
                <td class="label">Dari</td>
                <td class="colon">:</td>
                <td>{{ $dari ?? 'Kepala Biro Keuangan' }}</td>
            </tr>
            <tr>
    ...
    <div class="content">
        ...
        <p>Apabila tidak ada koreksi, mohon perkenan Bapak untuk menandatangani Surat pada poin 1 dan nota dinas dimaksud untuk diteruskan kepada Sekretaris Jenderal DPR RI selaku Pengguna Barang Satker Setjen DPR RI.</p>

        <p>Atas perhatian dan perkenan Bapak, kami ucapkan terima kasih.</p>
    </div>

    <div class="signature">
        <p>{{ $dari ?? 'Kepala Biro Keuangan' }},</p>
        <div class="signature-name">{{ $pejabat_data['nama'] ?? 'Rahmad Budiaji' }}</div>
    </div>
</body>
</html>
