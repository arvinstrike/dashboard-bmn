...
<head>
    ...
    <title>Konfirmasi/Permintaan Data Penyewa - BMN</title>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 fw-bold mb-1 text-dark">
                    <i class="bi bi-clipboard-check text-primary-dark me-2"></i>Konfirmasi/Permintaan Data Penyewa
                </h1>
                <p class="text-muted mb-0">Verifikasi dan proses data penyewa BMN untuk pemanfaatan</p>
            </div>
        </div>
        ...
        <div class="table-container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3 class="h5 mb-0 text-dark">
                    <i class="bi bi-list-check text-primary-dark me-2"></i>Daftar Permintaan Verifikasi
                </h3>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="bi bi-file-text text-primary-dark me-2"></i>Formulir Verifikasi
                        </h5>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="verification-number" class="form-label">Nomor Konfirmasi</label>
                                        <input type="text" class="form-control" id="verification-number" placeholder="Nomor konfirmasi permintaan data penyewa...">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="verification-date" class="form-label">Tanggal</label>
                                        <input type="date" class="form-control" id="verification-date">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="verification-documents" class="form-label">Dokumen</label>
                                <textarea class="form-control" id="verification-documents" rows="3" placeholder="Deskripsi dokumen..."></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="verification-notes" class="form-label">Catatan</label>
                                <textarea class="form-control" id="verification-notes" rows="3" placeholder="Catatan tambahan..."></textarea>
                            </div>
                            <div class="d-flex gap-2">
