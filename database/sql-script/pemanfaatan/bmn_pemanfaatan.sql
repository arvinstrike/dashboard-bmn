...
--
-- Host: localhost
-- Generation Time: Nov 18, 2025 at 03:50 AM
...
CREATE TABLE `bmn_pemanfaatan` (
  ...
  `surat_konfirmasi_tujuan` varchar(255) DEFAULT NULL,
  `surat_konfirmasi_peruntukan` varchar(255) DEFAULT NULL,
  `surat_konfirmasi_nomor_perjanjian_lama` varchar(255) DEFAULT NULL,
  `surat_konfirmasi_tanggal_berakhir` date DEFAULT NULL,
  `surat_konfirmasi_kasub_nama_nomor` varchar(255) DEFAULT NULL,
