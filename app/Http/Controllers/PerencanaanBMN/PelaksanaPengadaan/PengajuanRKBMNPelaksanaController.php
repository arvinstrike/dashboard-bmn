...
class PengajuanRKBMNPelaksanaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            //         ->get();
            $data = PengajuanRKBMNBagianModel::where('status', '=', 'Diajukan Ke Unit Pelaksana')
                    ->get();
     ...
     */
    public function kirimkekoordinatorpengaadaan(Request $request, $id)
    {
        // Validasi input
        ...
        try {
            ...
            if ($validated['approval'] === "setuju") {
                ...
                $pengajuan->status = 'Ditolak Pengadaan BMN';
