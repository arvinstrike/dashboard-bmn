...
/**
 * Utilization Dashboard Controller
 *
 * Handles CRUD operations for BMN Utilization (Monitoring Pemanfaatan BMN).
 * Document generation is handled separately by DocumentController.
 *
...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('utilization.dashboard', compact('utilizationData', 'bagianList'));
    }
